...
class AsyncAgentRunner:
    ...
    async def ainvoke(
        ...
        *,
        ...
        """Canonical async entry point. Alias for ``Initialize``."""
        return await self.Initialize(user_input, ChatHistory, stream, chat_history=chat_history)
    ...
    async def astream(
        ...
        completion = await self.Initialize(user_input, chat_history=chat_history)
